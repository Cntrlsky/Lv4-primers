...
OUT_DIR = os.path.join("Visualizations & Results", "Network Anomaly", "EDA", SCRIPT_NAME)
...
plt.tight_layout()
plt.savefig(os.path.join(OUT_DIR, "Network_Anomaly_Feature_Distributions.png"), dpi=150, bbox_inches="tight")
plt.show()
...
plt.tight_layout()
plt.savefig(os.path.join(OUT_DIR, "Network_Anomaly_Correlation_Heatmap.png"), dpi=150, bbox_inches="tight")
plt.show()
...
plt.tight_layout()
plt.savefig(os.path.join(OUT_DIR, "Network_Anomaly_Class_Imbalance.png"), dpi=150, bbox_inches="tight")
plt.show()
...
plt.tight_layout()
plt.savefig(os.path.join(OUT_DIR, "Network_Anomaly_Missing_Values.png"), dpi=150, bbox_inches="tight")
plt.show()
