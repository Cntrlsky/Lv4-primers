...
OUT_DIR = os.path.join("Visualizations & Results", "NIDS", "EDA", SCRIPT_NAME)
...
plt.tight_layout()
plt.savefig(os.path.join(OUT_DIR, "NIDS_Feature_Distributions.png"), dpi=150, bbox_inches="tight")
plt.show()
...
plt.tight_layout()
plt.savefig(os.path.join(OUT_DIR, "NIDS_Correlation_Heatmap.png"), dpi=150, bbox_inches="tight")
plt.show()
...
plt.tight_layout()
plt.savefig(os.path.join(OUT_DIR, "NIDS_Class_Imbalance.png"), dpi=150, bbox_inches="tight")
plt.show()
...
plt.tight_layout()
plt.savefig(os.path.join(OUT_DIR, "NIDS_Missing_Values.png"), dpi=150, bbox_inches="tight")
plt.show()
