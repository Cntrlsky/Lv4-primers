...
OUT_DIR = os.path.join("Visualizations & Results", "Botnet", "EDA", SCRIPT_NAME)
...
plt.tight_layout()
plt.savefig(os.path.join(OUT_DIR, "Botnet_Feature_Distributions.png"), dpi=150, bbox_inches="tight")
plt.show()
...
plt.tight_layout()
plt.savefig(os.path.join(OUT_DIR, "Botnet_Correlation_Heatmap.png"), dpi=150, bbox_inches="tight")
plt.show()
...
plt.tight_layout()
plt.savefig(os.path.join(OUT_DIR, "Botnet_Class_Imbalance.png"), dpi=150, bbox_inches="tight")
plt.show()
...
plt.tight_layout()
plt.savefig(os.path.join(OUT_DIR, "Botnet_Missing_Values.png"), dpi=150, bbox_inches="tight")
plt.show()
