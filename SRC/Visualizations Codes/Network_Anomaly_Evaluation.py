...
y_true=pd.read_csv("Data/Processed/Network_AnomalyY.csv")
...
plt.title('Network Anomaly Model Confusion Matrix')
plt.ylabel('Actual Label')
plt.xlabel('Predicted Label')
plt.savefig("Visualizations/Network Anomaly/Network_Anomaly_Confusion_Matrix.png")
plt.show()
#4. Generate Classification Report 
print("Network Anomaly Classification Report:\n")
...
#1. Convert labels to binary (Using lowercase 'label' column)
...
plt.title('Network Anomaly ROC-AUC Curve')
plt.xlabel('False Positive Rate')
plt.ylabel('True Positive Rate')
plt.legend(loc="lower right")
plt.savefig("Visualizations/Network Anomaly/Network_Anomaly_ROC_Curve.png")
plt.show()
...
#3. Save results
with open("Visualizations/Network Anomaly/Network_Anomaly_CV_Results.txt","w") as f:
...
#4. Save proof
with open("Visualizations/Network Anomaly/Network_Anomaly_Baseline_Comparison.txt","w") as f:
